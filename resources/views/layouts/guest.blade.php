...
<div class="relative min-h-screen bg-slate-950 flex flex-col items-center justify-center overflow-hidden p-4 py-10">
    {{-- Ambient background --}}
    ...
    <div class="relative w-full max-w-md bg-white rounded-2xl shadow-(--shadow-pop) p-8 animate-(--animate-fade-up)" style="animation-delay: 60ms">
        @yield('content')
    </div>
